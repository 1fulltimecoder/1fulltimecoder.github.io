...
categories: [Python, Frameworks and Libraries]
...
* Audio
    ...
    * [mingus](https://bspaans.github.io/python-mingus/) - An advanced music theory and notation package with MIDI file and playback support.
...
* [BitBake](https://www.yoctoproject.org/docs/1.6/bitbake-user-manual/bitbake-user-manual.html) - A make-like build tool for embedded Linux.
* [buildout](https://www.buildout.org/en/latest/) - A build system for creating, assembling and deploying applications from multiple parts.
* [PlatformIO](https://github.com/platformio/platformio-core) - A console tool to build code with different development platforms.
* [pybuilder](https://github.com/pybuilder/pybuilder) - A continuous build tool written in pure Python.
* [SCons](https://www.scons.org/) - A software construction tool.
...
* [dogpile.cache](https://dogpilecache.readthedocs.io/en/latest/) - dogpile.cache is a next generation replacement for Beaker made by the same authors.
* [HermesCache](https://pypi.org/project/HermesCache/) - Python caching library with tag-based invalidation and dogpile effect prevention.
* [pylibmc](https://github.com/lericson/pylibmc) - A Python wrapper around the [libmemcached](https://libmemcached.org/libMemcached.html) interface.
* [python-diskcache](https://www.grantjenks.com/docs/diskcache/) - SQLite and file backed cache backend with faster lookups than memcached and redis.
...
* Command-line Application Development
    ...
    * [click](https://click.pocoo.org/dev/) - A package for creating beautiful command line interfaces in a composable way.
    * [cliff](https://docs.openstack.org/developer/cliff/) - A framework for creating command-line programs with multi-level commands.
    * [docopt](https://docopt.org/) - Pythonic command line arguments parser.
...
* [python-future](https://python-future.org/index.html) - The missing compatibility layer between Python 2 and Python 3.
...
* [eventlet](https://eventlet.net/) - Asynchronous framework with WSGI support.
* [gevent](https://www.gevent.org/) - A coroutine-based Python networking library that uses [greenlet](https://github.com/python-greenlet/greenlet).
...
* [jsonschema](https://github.com/Julian/jsonschema) - An implementation of [JSON Schema](https://json-schema.org/) for Python.
...
* [Pygal](https://www.pygal.org/en/latest/) - A Python SVG Charts Creator.
* [PyGraphviz](https://pypi.org/project/pygraphviz/) - Python interface to [Graphviz](https://www.graphviz.org/).
...
* MySQL - [awesome-mysql](https://shlomi-noach.github.io/awesome-mysql/)
...
* PostgreSQL - [awesome-postgres](https://github.com/dhamaniasad/awesome-postgres)
    * [psycopg2](https://initd.org/psycopg/) - The most popular PostgreSQL adapter for Python.
...
* [moment](https://github.com/zachwill/moment) - A Python library for dealing with dates/times. Inspired by [Moment.js](https://momentjs.com/).
...
* Tracing
    * [lptrace](https://github.com/khamidou/lptrace) - [strace](https://man7.org/linux/man-pages/man1/strace.1.html) for Python programs.
...
* [Nuitka](https://nuitka.net/) - Compile scripts, modules, packages to an executable or extension module.
* [py2app](https://pythonhosted.org/py2app/) - Freezes Python scripts (Mac OS X).
* [py2exe](https://www.py2exe.org/) - Freezes Python scripts (Windows).
* [pyarmor](https://github.com/dashingsoft/pyarmor) - A tool used to obfuscate python scripts, bind obfuscated scripts to fixed machine or expire obfuscated scripts.
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) - Converts Python programs into stand-alone executables (cross-platform).
* [pynsist](https://pynsist.readthedocs.io/en/latest/) - A tool to build Windows installers, installers bundle Python itself.
...
* [django-oscar](https://oscarcommerce.com/) - An open-source e-commerce framework for Django.
...
* [saleor](https://getsaleor.com/) - An e-commerce storefront for Django.
...
* [SWIG](https://www.swig.org/Doc1.3/Python.html) - Simplified Wrapper and Interface Generator.
...
* [curses](https://docs.python.org/3/library/curses.html) - Built-in wrapper for [ncurses](https://www.gnu.org/software/ncurses/) used to create terminal GUI applications.
...
* [Cocos2d](https://cocos2d.org/) - cocos2d is a framework for building 2D games, demos, and other graphical/interactive applications.
...
* [PyOgre](https://www.ogre3d.org/tikiwiki/PyOgre) - Python bindings for the Ogre 3D render engine, can be used for games, simulations, anything 3D.
* [PyOpenGL](https://pyopengl.sourceforge.net/) - Python ctypes bindings for OpenGL and it's related APIs.
...
* [ino](https://inotool.org/) - Command line toolkit for working with [Arduino](https://www.arduino.cc/).
* [keyboard](https://github.com/boppreh/keyboard) - Hook and simulate global keyboard events on Windows and Linux.
* [mouse](https://github.com/boppreh/mouse) - Hook and simulate global mouse events on Windows and Linux.
* [Pingo](https://www.pingo.io/) - Pingo provides a uniform API to program devices like the Raspberry Pi, pcDuino, Intel Galileo, etc.
...
* [wand](https://github.com/dahlia/wand) - Python bindings for [MagickWand](https://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.
...
* [Cython](https://cython.org/) - Optimizing Static Compiler for Python.
...
* [Numba](https://numba.pydata.org/) - Python JIT compiler to LLVM aimed at scientific Python.
...
* [PyICU](https://github.com/ovalhub/pyicu) - A wrapper of International Components for Unicode C++ library ([ICU](https://site.icu-project.org/)).
...
* [APScheduler](https://apscheduler.readthedocs.io/en/latest/) - A light but powerful in-process task scheduler that lets you schedule functions.
...
* [logbook](https://logbook.readthedocs.io/en/stable/) - Logging replacement for Python.
...
* [Spark ML](https://spark.apache.org/docs/latest/ml-guide.html) - [Apache Spark](https://spark.apache.org/)'s scalable Machine Learning library.
...
* [pythonlibs](https://www.lfd.uci.edu/~gohlke/pythonlibs/) - Unofficial Windows binaries for Python extension packages.
 ...
 * [Bicycle Repair Man](https://bicyclerepair.sourceforge.net/) - Bicycle Repair Man, a refactoring tool for Python.
...
* Django
    * [django-rest-framework](https://www.django-rest-framework.org/) - A powerful and flexible toolkit to build web APIs.
    * [django-tastypie](https://tastypieapi.org/) - Creating delicious APIs for Django apps.
* Flask
...
* [rospy](https://wiki.ros.org/rospy) - This is a library for ROS (Robot Operating System).
...
* [zeroRPC](https://github.com/0rpc/zerorpc-python) - zerorpc is a flexible RPC implementation based on [ZeroMQ](https://zeromq.org/) and [MessagePack](https://msgpack.org/).
...
* [Biopython](https://biopython.org/wiki/Main_Page) - Biopython is a set of freely available tools for biological computation.
* [cclib](https://cclib.github.io/) - A library for parsing and interpreting the results of computational chemistry packages.
* [Colour](https://colour-science.org/) - Implementing a comprehensive number of colour theory transformations and algorithms.
...
* [Open Babel](https://openbabel.org/wiki/Main_Page) - A chemical toolbox designed to speak the many languages of chemical data.
...
* [whoosh](https://whoosh.readthedocs.io/en/latest/) - A fast, pure Python search engine library.
...
* [Mako](https://www.makotemplates.org/) - Hyperfast and lightweight templating for the Python platform.
...
* GUI / Web Testing
    ...
    * [Selenium](https://pypi.org/project/selenium/) - Python bindings for [Selenium](https://www.seleniumhq.org/) WebDriver.
...
* Unique identifiers
    * [hashids](https://github.com/davidaurelio/hashids-python) - Implementation of [hashids](https://hashids.org) in Python.
...
* [fanstatic](https://www.fanstatic.org/en/latest/) - Packages, optimizes, and serves static file dependencies as Python packages.
* [fileconveyor](https://wimleers.com/fileconveyor) - A daemon to detect and sync files to CDNs, S3 and FTP.
...
* Synchronous
    ...
    * [Flask](https://flask.pocoo.org/) - A microframework for Python.
        * [awesome-flask](https://github.com/humiaozuzu/awesome-flask)
    * [Pyramid](https://pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
        * [awesome-pyramid](https://github.com/uralbash/awesome-pyramid)
    * [Masonite](https://github.com/MasoniteFramework/masonite) - The modern and developer centric Python web framework.
* Asynchronous
    * [Tornado](https://www.tornadoweb.org/en/latest/) - A web framework and asynchronous networking library.
